...
| 天正实体封装 | ~54% | wall/dimension/wall_thickness_dimension/opening_dimension/two_point_dimension/elevation/coordinate/symmetry/north_arrow/break_line/explode_read/search_room 已 E2E 验证，axis_lines 普通线轴网替代可执行，door 部分验证；标准柱/轴网/导出受 #32770 对话框阻碍（仅 dry-run）；楼梯/屋顶等未动工 |
...
| `scripts/itest_01..35_*.py` | 可重复的联调管线（引导/探测/试驱动/E2E/MCP stdio/恢复/清理/LOGFILEMODE 提示捕获/弹框侦察） |

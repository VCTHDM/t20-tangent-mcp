...
# ==========================================================================
# 9. tangent — T20 天正建筑实体 (LISP 模板 + 参数注入)
# ==========================================================================
# 经独立模块注册, 仅生成 LISP 并走现有 execute_lisp 通道, 不触碰 dispatcher/IPC。

from t20_mcp.tools.tangent import register_tangent_tool  # noqa: E402
